...
async function loadCommands(client) {
    ...
    function loadFolder(folder) {
        const items = (0, fs_1.readdirSync)(folder, { withFileTypes: true });
...
async function registerCommands(client, commands) {
    ...
    await rest.put(discord_js_1.Routes.applicationCommands(process.env.CLIENT_ID), { body: commands.map(cmd => cmd.data.toJSON()) });
